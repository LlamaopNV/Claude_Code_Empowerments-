...
| `forgemaster` | development | Drives one rough idea end to end to shipped, tested code by sequencing the other skills — intake, idea-forge hardening, spec, tests-first subagent build, and hook-enforced quality gates, with a resumable artifact per stage. |
